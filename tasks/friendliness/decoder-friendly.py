...
controlled_model_args = {
    ...
    #     "initial_learning_rate": 0.02, "decay_steps": 500, "decay_rate": 0.8, "name": "default_opt_lr"},
    ...
    "reconstruction_network_args": {
        ...
        "eta_init": 0.1, "eps_init": 0.8, "bhc_type": "gated", "bhc_threshold": 50, "bhc_weight_init": 100,
