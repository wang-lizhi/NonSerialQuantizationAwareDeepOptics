...
# RGGB_BAYER_PATTERN_MASK_PRELOAD_RESOLUTIONS = [256, 512, 768, 1024]
RGGB_BAYER_PATTERN_MASK_PRELOAD_RESOLUTIONS = [1024]
...
#     # print(RGGB_BAYER_PATTERN_MASK_256)
#     for i in range(0, 1024, 256):
#         for j in range(0, 1024, 256):
#             print("cropped_%d_%d = dataset_1024.map(lambda _img: safe_crop_to_bounding_box(_img, %d, %d, 256, 256))" % (
#             i, j, i, j))
